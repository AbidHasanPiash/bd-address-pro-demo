...
type TabType = 'names' | 'raw' | 'hierarchy' | 'lookup';
      ...
      {activeTab === 'hierarchy' && (
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <h4 className="font-semibold mb-2">getDistrictsByDivision / getUpazilasByDivision</h4>
              <select
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <h4 className="font-semibold mb-2">getUpazilasByDistrict</h4>
              <select
              ...
              {selectedDistrictId && (
                <div>
                  ...
                  <ul className="text-sm mt-1 max-h-48 overflow-auto">
